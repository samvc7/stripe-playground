  ...
  return (
    <div className="flex flex-col items-center justify-center mt-6 gap-4 py-12 px-16">
      ...
      <div className="flex flex-row gap-6 mt-12 w-full">
        <CardSubscription planName="basic" />
        <CardSubscription planName="premium" />
        <CardSubscription planName="ultimate" />
      </div>
    </div>
  )
}
...
const CardSubscription = ({ planName }: CardSubscriptionProps) => {
